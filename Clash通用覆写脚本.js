...
function overwriteProxyGroups(params) {
    ...
    const groups = [
        ...
        },
        {
            ...
            proxies: ["All-自动", "HK-自动", "TW-自动", "JP-自动", "SG-自动", "US-自动",  "KR-自动", "UK-自动", "FR-自动", "DE-自动", "0.1-自动"],
        },
        {
            name: "Select",
            type: "select",
        ...
        },
        {
            name: "AIGC",
            type: "select",
            proxies: ["Proxy", "Select", "DIRECT", "HK-自动", "TW-自动", "JP-自动", "SG-自动", "US-自动", "KR-自动", "UK-自动", "FR-自动", "DE-自动", "0.1-自动"],
